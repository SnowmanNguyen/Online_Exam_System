                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php  echo $i; ?></td>
                                <td><?php 
                                  $uname = mysqli_real_escape_string($conn, $row['uname']);
                                  $ex="SELECT fname FROM student WHERE uname='$uname' LIMIT 1";
                                  $name = mysqli_query($conn, $ex);
                                  $findname = mysqli_fetch_assoc($name);
                                  echo $findname ? htmlspecialchars($findname['fname']) : htmlspecialchars($row['uname']); ?></td>
